...
MARS via LASSO is a LASSO variation of the usual MARS method, introduced in 
...
a software package for optimization, and  
[Rmosek](https://docs.mosek.com/latest/rmosek/install-interface.html), the MOSEK 
interface in R.
